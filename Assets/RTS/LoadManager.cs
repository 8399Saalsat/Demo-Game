...
namespace RTS
{
		public class LoadManager
		{
				public static void LoadGame (string filename)
				{
						...
						if (!File.Exists (path)) {
								Debug.Log ("Unable to find " + path + ". Loading failed");
								return;
						}
						...
						while (reader.Read()) {
								if (reader.Value != null) {
										if (reader.TokenType == JsonToken.PropertyName)
												...
												switch (currVal) {
												case "x":
														vector.x = (float)(double)reader.Value;
														break;
												case "y":
														vector.y = (float)(double)reader.Value;
														break;
												case "z":
														vector.z = (float)(double)reader.Value;
														break;
												default:
														break;
												}
						...
						while (reader.Read()) {
								if (reader.Value != null) {
										if (reader.TokenType == JsonToken.PropertyName)
												...
												switch (currVal) {
												case "x":
														quaternion.x = (float)(double)reader.Value;
														break;
												case "y":
														quaternion.y = (float)(double)reader.Value;
														break;
												case "z":
														quaternion.z = (float)(double)reader.Value;
														break;
												case "w":
														quaternion.w = (float)(double)reader.Value;
														break;
												default:
														break;
												}
